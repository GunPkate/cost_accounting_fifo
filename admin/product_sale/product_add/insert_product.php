...
<div class="container mt-4">
  <form action="insert-p.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label for="address">Sale Price:</label>
      <input type="number" class="form-control" name="sale" placeholder="Enter Sale price" required="">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="Date" class="form-control" name="date" placeholder="Enter Date" value="<? date()?>">
    </div>
